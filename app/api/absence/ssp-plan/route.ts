// C:\Projects\wageflow01\app\api\absence\ssp-plan\route.ts
...
export async function GET(req: Request) {
  ...
  try {
    ...
    return NextResponse.json(
      { ok: false, error: "server_error", message: msg || "Unexpected error while computing SSP plans for this run." },
      { status: 500 }
    );
  }
}