  ...
  return (
    <div className="min-h-screen">
      <div className="w-full bg-white border-b border-neutral-200 px-6 py-4">
        <h1 className="text-xl font-semibold text-blue-700">New Shared Parental Leave</h1>
      </div>

      <div className="p-6 space-y-4">
        <p className="text-sm text-gray-700">
          Preview stub. Shared Parental wizard is disabled in preview mode.
        </p>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <label className="block">
              <span className="text-xs text-gray-600">First leave start date</span>
              <input
                type="date"
                className="mt-1 w-full rounded border border-gray-300 px-3 py-2 text-sm"
                readOnly
