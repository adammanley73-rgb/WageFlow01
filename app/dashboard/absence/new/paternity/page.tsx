...
export default function PaternityLeavePage() {
  return (
    <div className="min-h-screen">
      <div className="w-full bg-white border-b border-neutral-200 px-6 py-4">
        <h1 className="text-xl font-semibold text-blue-700">New Paternity Leave</h1>
      </div>

      <div className="p-6 space-y-4">
        <p className="text-sm text-gray-700">
          Preview stub. Paternity wizard is disabled in preview mode.
        </p>
