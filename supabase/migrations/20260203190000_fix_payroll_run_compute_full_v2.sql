-- C:\Users\adamm\Projects\wageflow01\supabase\migrations\20260203190000_fix_payroll_run_compute_full_v2.sql
-- Fix payroll_run_compute_full to match current schema:
-- - payroll_run_pay_elements has payroll_run_employee_id + pay_element_type_id (no run_id/employee_id/element_code/is_deduction)
-- - pay_element_types has code + side
