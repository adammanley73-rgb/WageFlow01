...
function buildEmployeeRow(
  ...
  return {
    ...
    recovery_applied_amount: round2(toNumberSafe(pickFirst(att?.recovery_applied_amount, att?.recoveryAppliedAmount, 0))),
    recoveryAppliedAmount: round2(toNumberSafe(pickFirst(att?.recovery_applied_amount, att?.recoveryAppliedAmount, 0))),
    recovery_balance_after_amount: round2(toNumberSafe(pickFirst(att?.recovery_balance_after_amount, att?.recoveryBalanceAfterAmount, 0))),
    recoveryBalanceAfterAmount: round2(toNumberSafe(pickFirst(att?.recovery_balance_after_amount, att?.recoveryBalanceAfterAmount, 0))),
    recovery_application_status: String(pickFirst(att?.recovery_application_status, att?.recoveryApplicationStatus, "none") || "none"),
    recoveryApplicationStatus: String(pickFirst(att?.recovery_application_status, att?.recoveryApplicationStatus, "none") || "none"),
    recovery_application_note: pickFirst(att?.recovery_application_note, att?.recoveryApplicationNote, null),
    recoveryApplicationNote: pickFirst(att?.recovery_application_note, att?.recoveryApplicationNote, null),
    calc_mode: calcMode,
